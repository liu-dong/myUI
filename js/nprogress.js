layui.define(function (n) {
    !function (e, t) {
        ...
        u.configure = function (n) {
            ...
            let r, s = t.querySelector(c.barSelector),
            ...
            let n = document.getElementById("nprogress");
            n && a(n)
        ...
        const l = function () {
            ...
            f = function () {
                ...
                function e(n) {
                    ...
                    if (n in e) return n;
                    for (let t, r = i.length, s = n.charAt(0).toUpperCase() + n.slice(1); r--;)
        ...
        return u
    }), layui.link("./css/nprogress.css"), n("nprogress")
});